...
if platform.system() == "Windows":
    ...
    BOOST_ROOT="C:/local/boost_1_62_0" # 64-bit binaries (boost_1.62.0) downloaded from https://boost.teeks99.com
    BOOST_LIBDIR="C:/local/boost_1_62_0/lib64-msvc-14.0"
    # Make sure both python and boost binaries are either x64 or x86 and accordingly update path to opencv binaries
    OPENCV_DIR="D:/Users/petrofac/Downloads/opencv24/opencv/build/x64/vc12"
    OPENCV_VER="2410"
...
if platform.system() == "Windows":
    ...
    MSVC_USE_SCRIPT=r'D:/visual/VC/Auxiliary/Build/vcvars64.bat')
